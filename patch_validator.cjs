...
const fileContent = `export type ComplianceStatus = 'PASS' | 'FAIL' | 'INCOMPLETE';
...
fs.mkdirSync('src/validation', { recursive: true });
fs.writeFileSync('src/validation/VentilationValidator.ts', fileContent);
