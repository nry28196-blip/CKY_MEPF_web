...
describe('ASHRAE 62.1 PRODUCTION SAFETY AUTOMATED TESTS', () => {
  ...
  describe('MATHEMATICAL SYNTHETIC TESTS (VERIFIED FIXTURES ONLY)', () => {
    it('14. calculates zone successfully with mathematical golden test (design occupancy)', () => {
    ...
    it('15. calculates zone successfully with synthetic default-occupancy test', () => {
      const space = createSyntheticVerifiedSpaceType('2025');
      const ez = createSyntheticVerifiedEz('2025');
      const result = Ashrae621ZoneService.calculateZone({
        expectedStandard: 'ASHRAE 62.1', expectedEdition: '2025', spaceType: space,
    ...
    it('16. calculates exhaust arithmetic successfully using synthetic verified exhaust test', () => {
