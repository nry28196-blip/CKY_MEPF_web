            ...
            <div className="bg-slate-950/50 rounded-lg border border-slate-800/50 overflow-hidden">
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="flex justify-between items-center pb-2 border-b border-slate-800/50">
                  ...
                  <span className="text-[10px] font-mono text-slate-400">{selectedId === 'custom' ? customRate : (isMetric ? category.rateMetric : category.rateImp)} {selectedId === 'custom' ? flowUnit : (isMetric ? category.unitLabelMetric : category.unitLabelImp)}</span>
                </div>
