...
export const IPC_FIXTURES: PlumbingFixtureData[] = [
  { id: 'wc_pub_fv', name: 'Water Closet (Public) - Flushometer', wsfu: 10, dfu: 6, lu: 2.0, du: 2.0, isFlushometer: true },
  ...
  { id: 'urinal_pub_fv', name: 'Urinal (Public) - 1" Flushometer', wsfu: 5.0, dfu: 4, lu: 1.5, du: 0.5, isFlushometer: true },
