...
describe('ASHRAE 62.1-2025 Exhaust Space Calculations', () => {
  it('Should correctly compute Art Classrooms rate per Unit', () => {
    const exhaustType: Ashrae621ExhaustType = {
      ...
      reference: 'Table 6.5',
      edition: '2025',
      revisionState: { standard: 'ASHRAE 62.1', edition: '2025', baseEdition: '2025', publishedAddendaApplied: [], publishedErrataApplied: [], verificationDate: '', source: 'NOT_VERIFIED' }, sourceType: 'UNVERIFIED_DRAFT'
    };
